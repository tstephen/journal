...
* Committed to making the team greater than the sum of its parts through embedding best practices, open to new ideas and mentoring.
...
* Part of the central platform operations team responsible to maturing and rolling out the Elsevier cloud platform to over 40 product teams.  
...
* Design, guide to apprentice developer and personally contribute to the platform introspection and recomendation engine to ensure continuous improvement of products along security, cost, reliability and performance dimensions.

*Technologies*: AWS (API Gateway, DynamoDB, IAM, Kubernetes, Lambda, S3), Artifactory, CheckMarx, Docker, GitHub Actions, GitHub Advanced Security, FastAPI, OpenAPI (Swagger), NewRelic, Python, Terraform
...
* Full stack development (Dev _and_ Ops) with Agile practices.
* Security cleared.

*Technologies:*
* AWS, Ansible, Python 3, Robot Framework, Helm, Kubernetes, OpenShift, Terraform
* Angular, BPMN, Docker, Java 8 & 11, Micro-services, Postgres, Rest APIs, Spring Boot, TypeScript,
* Keycloak, OAuth, OpenID
...
*Technologies:* Ansible, Java 8 & 11, Spring MVC, Spring Security, Spring Boot, JavaScript, JPA, Liquibase, JWT, Keycloak, 
