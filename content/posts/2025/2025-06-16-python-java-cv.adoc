---
title: "2025-06-16 Python Java CV"
date: 2025-06-16
draft: false
tags:
- "2025"
...
* SRE: Migrating legacy backend services into cloud hosting; improving scalability and maintainability through both code review and observability tooling.
...
* Technical founder of a customer management automation platform specifically designed for small and medium enterprises (SMEs).
* Designed and delivered the service, provided sales support, and managed the outsourced development team.
